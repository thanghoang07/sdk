...
namespace huidu.sdk
{
    ...
    public class UDPServices : ISocket
    {
        ...
        private static int BIND_PORT = 65261;            //No requirement for locally bound port number
        private static string BIND_IP = "169.254.222.129";            //No requirement for locally bound port numbe
        ...
        private void InitSocket()
        {
            ...
            IPEndPoint ip = new IPEndPoint(IPAddress.Parse(BIND_IP), BIND_PORT);
        ...
        private void StartSearchDevice()
        {
            ...
            this.searchTimer_.Elapsed += this.TimerTick;
            this.searchTimer_.Interval = SEARCH_DELAY;
            this.searchTimer_.Start();
            this.searchTimer_.AutoReset = true;
        }
